...
export function loadConfig(): BotConfig {
  ...
  return {
    ...
    maxCrankStalenessSlots: Number(process.env.MAX_CRANK_STALENESS ?? "200"),
    ...
    quoteIntervalMs: Number(process.env.QUOTE_INTERVAL_MS ?? "5000"),
    ...
    maxPriceStalenessMs: Number(process.env.MAX_PRICE_STALENESS_MS ?? "10000"),
  };
}

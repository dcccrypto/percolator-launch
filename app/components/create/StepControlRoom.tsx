...
export interface StepControlRoomProps {
  ...
  onTradingFeeBpsChange: (bps: number) => void;
 ...
 * (leverage, fee, liquidity, insurance); everything else — price feed, slab
      ...
      <div className="rounded-[4px] border border-[var(--border)] bg-[var(--panel-bg)] p-5">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-6 sm:grid-cols-4">
          ...
          <RotaryDial
            ...
            caption="per trade"
            onChange={onTradingFeeBpsChange}
          />
          <RotaryDial
            label="Liquidity"
            value={lp}

...
// Geist (sans), Geist (mono), Outfit, and Inter Tight removed.
// Remaining 2 families are all actively consumed:
//   JetBrains Mono    → --font-mono, and fallback in --font-sans / --font-heading + inline styles
//   Plus Jakarta Sans → --font-sans, --font-heading, --font-display
const plusJakartaSans = Plus_Jakarta_Sans({ variable: "--font-plus-jakarta-sans", subsets: ["latin"], weight: ["400", "500", "600", "700"], display: "swap" });
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" suppressHydrationWarning data-scroll-behavior="smooth" className={`${plusJakartaSans.variable} ${jetbrainsMono.variable}`}>
      <head>

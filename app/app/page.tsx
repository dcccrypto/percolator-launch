        ...
        <ScrollReveal>
          <div className="grid grid-cols-1 gap-px overflow-hidden border border-[var(--border)] bg-[var(--border)] md:grid-cols-3">
            {HOW_STEPS.map((step, i) => (
              <article
                key={step.number}
                className="group relative bg-[var(--panel-bg)] p-4 sm:p-5 transition-colors duration-200 hover:bg-[var(--bg-elevated)] md:min-h-[180px]"
              >
                <div className="mb-4 flex items-start justify-between">
                  ...
                  <span className="text-[20px] font-normal tracking-tight text-[var(--text-muted)] transition-colors duration-200 group-hover:text-[var(--accent)]/40" style={{ fontFamily: "var(--font-heading)" }}>
                    {step.number}
                  </span>
                </div>
              ...
              <div className="grid grid-cols-2 gap-px overflow-hidden border border-[var(--border)] bg-[var(--border)] md:grid-cols-4">
                {[
                  ...
                  <div key={stat.label} className="bg-[var(--panel-bg)] p-4 sm:p-5 transition-colors duration-200 hover:bg-[var(--bg-elevated)]">
                    <p className="mb-2 text-[9px] font-medium uppercase tracking-[0.2em] text-[var(--text-muted)]">{stat.label}</p>
              ...
              {[
                ...
                <article key={f.title} className="group relative h-full bg-[var(--panel-bg)] p-4 sm:p-5 transition-colors duration-200 hover:bg-[var(--bg-elevated)]">
                  <div className="mb-4 flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-medium uppercase tracking-[0.2em] text-[var(--text-muted)] transition-colors duration-200 group-hover:text-[var(--accent)]/60">
                      {f.tag}
                    </span>
                  </div>
